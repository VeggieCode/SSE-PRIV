# Generated by Django 4.1.7 on 2023-05-12 13:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('licenciatura', models.CharField(blank=True, max_length=50, null=True, validators=[django.core.validators.RegexValidator('^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+(?: [a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*$', 'Sólo se permiten letras')])),
            ],
        ),
        migrations.CreateModel(
            name='Coordinador',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, max_length=45, null=True, validators=[django.core.validators.RegexValidator(message='El nombre solo debe contener letras y un espacio entre palabras', regex=re.compile('^[a-zA-ZáéíóúüñÁÉÍÓÚÜÑ]+(?: [a-zA-ZáéíóúüñÁÉÍÓÚÜÑ]+)*$'))])),
                ('apellido_paterno', models.CharField(blank=True, max_length=45, null=True, validators=[django.core.validators.RegexValidator('^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+(?: [a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*$', 'Sólo se permiten letras')])),
                ('apellido_materno', models.CharField(blank=True, max_length=45, null=True, validators=[django.core.validators.RegexValidator('^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+(?: [a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*$', 'Sólo se permiten letras')])),
                ...
                ('fecha_nacimiento', models.DateField(blank=True, null=True, validators=[student_module.models.validate_age_range])),
                ...
                ('nombre_ref_principal', models.CharField(blank=True, max_length=100, null=True)),
                ('celular_ref_principal', models.CharField(blank=True, max_length=10, null=True, validators=[django.core.validators.RegexValidator('^\\d{10}$', 'Sólo se permiten números de teléfono de 10 dígitos.')])),
