    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=45, null=True, validators=[django.core.validators.RegexValidator(message='El nombre solo debe contener letras y un espacio entre palabras', regex=re.compile('^[a-zA-ZáéíóúüñÁÉÍÓÚÜÑ]+(?: [a-zA-ZáéíóúüñÁÉÍÓÚÜÑ]+)*$'))])),
                ('apellido_paterno', models.CharField(max_length=45, null=True, validators=[django.core.validators.RegexValidator('^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+(?: [a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*$', 'Sólo se permiten letras')])),
                ('apellido_materno', models.CharField(max_length=45, null=True, validators=[django.core.validators.RegexValidator('^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+(?: [a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*$', 'Sólo se permiten letras')])),
                ('sexo', models.CharField(choices=[('', 'Seleccione sexo'), ('M', 'Masculino'), ('F', 'Femenino'), ('O', 'Prefiero no decirlo')], max_length=10, null=True)),
                ('fecha_nacimiento', models.DateField(null=True, validators=[student_module.models.validate_age_range])),
                ('fecha_ingreso_lic', models.IntegerField(null=True, validators=[django.core.validators.MaxValueValidator(2019)])),
                ('licenciatura_fei', models.CharField(blank=True, max_length=500, null=True)),
                ('correo', models.CharField(max_length=45, null=True, validators=[django.core.validators.RegexValidator('^([a-zA-Z0-9_\\-\\.]+)@([a-zA-Z0-9_\\-\\.]+)\\.([a-zA-Z]{2,5})$', 'Sólo se permiten direcciones de e-mail válidas.')])),
                ...
                ('celular', models.CharField(max_length=10, null=True, validators=[django.core.validators.RegexValidator('^\\d{10}$', 'Sólo se permiten números de teléfono de 10 dígitos.')])),
                ...
                ('correo_alterno', models.CharField(blank=True, max_length=45, null=True, validators=[django.core.validators.RegexValidator('^([a-zA-Z0-9_\\-\\.]+)@([a-zA-Z0-9_\\-\\.]+)\\.([a-zA-Z]{2,5})$', 'Sólo se permiten direcciones de e-mail válidas.')])),
                ...
                ('celular_ref_principal', models.CharField(max_length=10, null=True, validators=[django.core.validators.RegexValidator('^\\d{10}$', 'Sólo se permiten números de teléfono de 10 dígitos.')])),
                ('nombre_ref_auxiliar', models.CharField(blank=True, max_length=100, null=True)),
                ('celular_ref_auxiliar', models.CharField(blank=True, max_length=10, null=True, validators=[django.core.validators.RegexValidator('^\\d{10}$', 'Sólo se permiten números de teléfono de 10 dígitos.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activo', models.IntegerField()),
                ('id_estado', models.ForeignKey(db_column='id_estado', null=True, on_delete=django.db.models.deletion.CASCADE, to='student_module.estados', validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z]*$', 'Sólo se permiten caracteres alfanuméricos.')])),
            ],
        ),
        migrations.CreateModel(
            name='Localidades',
            fields=[
                ...
                ('municipio', models.ForeignKey(db_column='id_municipio', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='student_module.municipios', validators=[django.core.validators.RegexValidator('^[0-9a-zA-Z]*$', 'Sólo se permiten caracteres alfanuméricos.')])),
            ],
        ),
        migrations.CreateModel(
            name='Licenciatura',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_campus', models.CharField(blank=True, max_length=45, null=True, validators=[django.core.validators.RegexValidator('^[a-zA-ZñÑáéíóúÁÉÍÓÚ]+(?: [a-zA-ZñÑáéíóúÁÉÍÓÚ]+)*$', 'Sólo se permiten letras')])),
